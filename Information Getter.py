...
|___|_| |_|___/\__\__,_|____/ \___/_/\_\
		     ...
		     {U}{Y}~ {G}Information Getter {M}- {G}By HackWeiser360 {Y}~{UR}'''.format(Y=YELLOW,M=MAGENTA,G=GREEN,GR=GRAY,C=CYAN,U=UNDERLINE,UR=RUNDERLINE)
...
def Clear():
	if os.name == 'nt':
		os.system('cls')
		os.system('title Information getter by HackWeiser360')
	else:
		os.system('clear')
